          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                Fortune 500 companies for mission-critical system deployments and scalable
                architecture design.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (555) 847-2901</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive technical insights and infrastructure updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
